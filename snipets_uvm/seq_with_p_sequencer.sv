module seq_with_p_sequencer;
	...
	class A_equals_to_7_seq extends seq;
		...
		repeat(3)
		  	begin
			     `uvm_info("SEQ", $sformatf("p_sequencer.seqr_variable = %0d", p_sequencer.seqr_variable), UVM_LOW)
	...
	initial begin
		//qverilog seq_with_p_sequencer.sv
		//vcs -sverilog -ntb_opts uvm seq_with_p_sequencer.sv; ./simv
...
/*
Start time: 10:22:58 on Jun 29,2026
qverilog ../seq_with_p_sequencer.sv 
-- Compiling module seq_with_p_sequencer
** Note: (qverilog-2286) ../seq_with_p_sequencer.sv(3): Using implicit +incdir+/home/cad/eda/Mentor_Graphics/Questasim/questasim/uvm-1.1d/../verilog_src/uvm-1.1d/src from import uvm_pkg
-- Importing package mtiUvm.uvm_pkg (uvm-1.1d Built-in)

Top level modules:
	seq_with_p_sequencer
# vsim -lib work work.seq_with_p_sequencer -c -do "run -all; quit -f" -appendlog -l qverilog.log -vopt 
...
# Loading work.seq_with_p_sequencer(fast)
...
# --------------------------------------------------------------
# 
# UVM_INFO ../seq_with_p_sequencer.sv(98) @ 0: uvm_test_top.envh.agth[0].seqrh@@A_7_seq [SEQ] p_sequencer.seqr_variable = 21
# UVM_INFO ../seq_with_p_sequencer.sv(54) @ 0: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @653                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_with_p_sequencer.sv(98) @ 1: uvm_test_top.envh.agth[0].seqrh@@A_7_seq [SEQ] p_sequencer.seqr_variable = 21
# UVM_INFO ../seq_with_p_sequencer.sv(54) @ 1: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @682                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_with_p_sequencer.sv(98) @ 2: uvm_test_top.envh.agth[0].seqrh@@A_7_seq [SEQ] p_sequencer.seqr_variable = 21
# UVM_INFO ../seq_with_p_sequencer.sv(54) @ 2: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @686                                   
...
#    Time: 3 ns  Iteration: 60  Instance: /seq_with_p_sequencer
# End time: 10:23:02 on Jun 29,2026, Elapsed time: 0:00:04
# Errors: 0, Warnings: 0
*/

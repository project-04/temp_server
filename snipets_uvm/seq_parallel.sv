module seq_parallel;
	...
	class A_equals_to_3_seq extends seq;
		...
		repeat(3)
	  	...
	  	endtask
	endclass 
	class concurrent_seq extends uvm_sequence #(xtn);
		...
		//repeat(5)
		  	begin
			     ...
			     fork
			     	...
			     	A_3_seq.start(m_sequencer);
			     	//`uvm_do_on(A_7_seq, m_sequencer)
			     	//`uvm_do_on(A_3_seq, m_sequencer)
			     join
			end
	  	endtask
	endclass
	...
	initial begin
		//qverilog seq_parallel.sv
		//vcs -sverilog -ntb_opts uvm seq_parallel.sv; ./simv
...
/*
Start time: 09:42:28 on Jun 29,2026
qverilog ../seq_parallel.sv 
-- Compiling module seq_parallel
** Note: (qverilog-2286) ../seq_parallel.sv(3): Using implicit +incdir+/home/cad/eda/Mentor_Graphics/Questasim/questasim/uvm-1.1d/../verilog_src/uvm-1.1d/src from import uvm_pkg
-- Importing package mtiUvm.uvm_pkg (uvm-1.1d Built-in)

Top level modules:
	seq_parallel
# vsim -lib work work.seq_parallel -c -do "run -all; quit -f" -appendlog -l qverilog.log -vopt 
...
# Loading work.seq_parallel(fast)
...
# 
# All types registered with the factory: 52 total
...
# --------------------------------------------------------------
# 
# UVM_INFO ../seq_parallel.sv(54) @ 0: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @661                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_parallel.sv(54) @ 1: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @665                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_parallel.sv(54) @ 2: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @694                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_parallel.sv(54) @ 3: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @698                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_parallel.sv(54) @ 4: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @702                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_parallel.sv(54) @ 5: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @706                                   
...
#    Time: 6 ns  Iteration: 65  Instance: /seq_parallel
# End time: 09:42:32 on Jun 29,2026, Elapsed time: 0:00:04
# Errors: 0, Warnings: 0
*/

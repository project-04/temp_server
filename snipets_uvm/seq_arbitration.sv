...
/*	class test_A_7 extends test;
		...
		task run_phase(uvm_phase phase);
			...
			`uvm_info("TEST", $sformatf("The current arbitration set is: %s", envh.agth[0].seqrh.get_arbitration()), UVM_LOW)
			envh.agth[0].seqrh.set_arbitration(SEQ_ARB_WEIGHTED); //SEQ_ARB_FIFO, SEQ_ARB_WEIGHTED, SEQ_ARB_RANDOM, SEQ_ARB_STRICT_FIFO, SEQ_ARB_STRICT_RANDOM, SEQ_ARB_USER arbitration is delegated to the user-defined function, user_priority_arbitarion. That function will specify the next sequence to grant.
			`uvm_info("TEST", $sformatf("The current arbitration set is: %s", envh.agth[0].seqrh.get_arbitration()), UVM_LOW)
		     	...
		     	A_3_seq= A_equals_to_3_seq::type_id ::create("A_3_seq");
	 	     	...
	 	     	fork
	 	     		A_0_seq.start(envh.agth[0].seqrh,,100);
	 	     		A_1_seq.start(envh.agth[0].seqrh,,400);
	 	     		A_2_seq.start(envh.agth[0].seqrh,,300);
	 	     		A_3_seq.start(envh.agth[0].seqrh,,400);
	 	     	join
	...
	initial begin
		//qverilog seq_arbitration.sv
		//vcs -sverilog -ntb_opts uvm seq_arbitration.sv; ./simv
...
/*
Start time: 09:49:09 on Jun 29,2026
qverilog ../seq_arbitration.sv 
-- Compiling module seq_arbitration
** Note: (qverilog-2286) ../seq_arbitration.sv(3): Using implicit +incdir+/home/cad/eda/Mentor_Graphics/Questasim/questasim/uvm-1.1d/../verilog_src/uvm-1.1d/src from import uvm_pkg
-- Importing package mtiUvm.uvm_pkg (uvm-1.1d Built-in)

Top level modules:
	seq_arbitration
# vsim -lib work work.seq_arbitration -c -do "run -all; quit -f" -appendlog -l qverilog.log -vopt 
...
# Loading work.seq_arbitration(fast)
...
# --------------------------------------------------------------
# 
# UVM_INFO ../seq_arbitration.sv(276) @ 0: uvm_test_top [TEST] The current arbitration set is: SEQ_ARB_FIFO
# UVM_INFO ../seq_arbitration.sv(278) @ 0: uvm_test_top [TEST] The current arbitration set is: SEQ_ARB_WEIGHTED
# UVM_INFO ../seq_arbitration.sv(54) @ 0: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @669                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_arbitration.sv(54) @ 1: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @706                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_arbitration.sv(54) @ 2: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @673                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_arbitration.sv(54) @ 3: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @710                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_arbitration.sv(54) @ 4: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @677                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_arbitration.sv(54) @ 5: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @714                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_arbitration.sv(54) @ 6: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @665                                   
...
# --------------------------------------------------------------------------------------
# 
# UVM_INFO ../seq_arbitration.sv(54) @ 7: uvm_test_top.envh.agth[0].drvh [DRV] From drv--------------------------------------------------------------------------------------
# Name                           Type      Size  Value                                  
# --------------------------------------------------------------------------------------
# req                            xtn       -     @718                                   
...
#    Time: 8 ns  Iteration: 60  Instance: /seq_arbitration
# End time: 09:49:13 on Jun 29,2026, Elapsed time: 0:00:04
# Errors: 0, Warnings: 0
*/

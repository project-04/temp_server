module factory_overriding_dynamic_classes;
	...
	class old_drv extends driver;
		`uvm_component_utils(old_drv)
		function new(string name="old_drv", uvm_component parent);
			super.new(name, parent);
		endfunction
	endclass
	
	class new_drv extends driver;
		`uvm_component_utils(new_drv)
		function new(string name="new_drv", uvm_component parent);
			super.new(name, parent);
		endfunction
	endclass

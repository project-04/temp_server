...
modport DUV(input d0,d1,rst,sel,clk,output q);  //it will work for task's. with out using import taks.
...
modport DUV_WITH_CB_AND_IMPROT_TASK(clocking cb, import sync_reset , import load_d0, import load_d1 ); 

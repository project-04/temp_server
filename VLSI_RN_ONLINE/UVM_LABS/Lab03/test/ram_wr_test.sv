...
task ram_wr_test::run_phase(uvm_phase phase);
	...
	#100;
	`uvm_info("RAM_WR_TEST","This is run_phase in env", UVM_LOW)
...
function void ram_wr_test::extract_phase(uvm_phase phase);
	...
	`uvm_info("RAM_WR_TEST","This is extract_phase in env", UVM_LOW)
endfunction
   
//-----------------  Add UVM check() phase   -------------------//
function void ram_wr_test::check_phase(uvm_phase phase);
	super.check_phase(phase);
	`uvm_info("RAM_WR_TEST","This is check_phase in env", UVM_LOW)
endfunction

//-----------------  Add UVM report() phase   -------------------//
function void ram_wr_test::report_phase(uvm_phase phase);
	super.report_phase(phase);
	`uvm_info("RAM_WR_TEST","This is report_phase in env", UVM_LOW)
endfunction   

...
function ram_wr_agent::new(string name = "ram_wr_agent", uvm_component parent = null); ///////////////why agent parent null///////////////////////////////////////////////////////
...
function void ram_wr_agent::connect_phase(uvm_phase phase);
	if(m_cfg.is_active==UVM_ACTIVE)
		begin
			drvh.seq_item_port.connect(seqrh.seq_item_export);///////////////////seq_item_port vs seq_item_export/////////////////////////////////////////////////////////////
  		end
endfunction

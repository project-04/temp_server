...
class ram_base_test extends uvm_test;
   ...
   // Factory Registration
    ...
    ram_rand_wr_xtns ram_rand_wr_xtnsh;
	//------------------------------------------
	// METHODS
	//------------------------------------------
...
function void ram_rand_addr_test::start_of_simulation_phase(uvm_phase phase);
	...
	//uvm_config_db #(uvm_object_wrapper)::set(this, "ram_envh.wr_agnth.seqrh.main_phase", "default_sequence", ram_rand_wr_xtns::get_type());

	uvm_config_db #(uvm_object_wrapper)::set(this, "ram_envh.wr_agnth.seqrh.run_phase", "default_sequence", ram_even_wr_xtns::get_type());

	//ram_rand_wr_xtnsh = ram_rand_wr_xtns::type_id::create("ram_rand_wr_xtnsh");
	//uvm_config_db #(uvm_sequence_base)::set(this, "ram_envh.wr_agnth.seqrh.main_phase", "default_sequence", ram_rand_wr_xtnsh);
endfunction

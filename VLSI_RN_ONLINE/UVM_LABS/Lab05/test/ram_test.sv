...
//-----------------  run() phase method  -------------------//
 task ram_single_addr_test::run_phase(uvm_phase phase);
	...
	ram_single_addr_wr_xtnsh = ram_single_addr_wr_xtns::type_id::create("ram_single_addr_wr_xtnsh", this);
...
super.run_phase(phase);
	...
	//create instance for sequence
	ram_ten_wr_xtnsh = ram_ten_wr_xtns::type_id::create("ram_ten_wr_xtnsh", this);
...
super.run_phase(phase);
	...
	//create instance for sequence
	ram_odd_wr_xtnsh = ram_odd_wr_xtns::type_id::create("ram_odd_wr_xtnsh", this);
...
super.run_phase(phase);
	...
	//create instance for sequence
	ram_even_wr_xtnsh = ram_even_wr_xtns::type_id::create("ram_even_wr_xtnsh", this);

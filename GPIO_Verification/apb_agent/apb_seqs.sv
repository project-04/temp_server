...
task input_seqs::body();
   ...
   begin
       ...
       // RGPIO_IN Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h0;PWDATA=='hff00_ffff;})
       finish_item(req);

       // RGPIO_OUT Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h1;PWDATA==0;})
       finish_item(req);
              	
       // RGPIO_OE Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h2;PWDATA=='h1111_1111;})
       finish_item(req);
       
       // RGPIO_INTE Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h3;PWDATA==0;})
       finish_item(req);

       // RGPIO_PTRIG Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h4; PWDATA==0;})
       finish_item(req);

       // RGPIO_AUX Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h5;PWDATA=='h1111_1111;})
       finish_item(req);
       
       // RGPIO_CTRL Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h6; PWDATA[1:0]=='b00;})
       finish_item(req);
       ...
       // RGPIO_ECLK Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h8;PWDATA==0;})
       finish_item(req);
       
       // RGPIO_NEG Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b1; PADDR=='h9;PWDATA==0;})
       finish_item(req);
...
task apb_read_seqs::body();
   ...
   begin
       ...
       // RGPIO_IN Register
       start_item(req);
       assert(req.randomize() with {PWRITE==1'b0; PADDR=='h0;PWDATA==0;})
       finish_item(req);

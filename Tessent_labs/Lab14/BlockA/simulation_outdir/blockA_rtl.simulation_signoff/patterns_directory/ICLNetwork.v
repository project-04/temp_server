...
// Filename       : ./blockA_tsdb/patterns/blockA_rtl.patterns_signoff/ICLNetwork.v
        ...
        if (_write_DIAG_file == 1) begin
          if (_DIAG_file_header == 0) begin
            if ((_start_pat > -1) && (_end_pat > -1)) begin
              ...
              _diag_file = $fopen("ICLNetwork.v.fail");
            end
        ...
        if (_write_MASK_file == 1) begin
          if (_MASK_file_header == 0) begin
            if ((_start_pat > -1) && (_end_pat > -1)) begin
              ...
              _mask_file = $fopen("ICLNetwork.v.mask");
            end
            $fwrite(_mask_file, "%s\n%s\n", "type mask", "");
            _MASK_file_header = 1;
          end
...
`ifdef debussy
  initial begin
    $fsdbDumpfile("ICLNetwork.v.fsdb");
    $fsdbDumpvars;
  end
`endif
      ...
      case (_pat_type)
         ...
         3'b011:  begin // status message vector
            ...
            case (_message_index)
               ...
               20: begin
                  $display($realtime, "ns: Pattern_set blockA");
               end
               21: begin
                  $display($realtime, "ns:  Activate selection for scan mux blockA_rtl_tessent_sib_sti_inst.scan_in_mux, selection 1: sib, ltest_en = 2'bxx -> scan_in_mux = ijtag_si");
               end
               22: begin
                  $display($realtime, "ns:  Scan in verification pattern 1 to the scan register blockA_rtl_tessent_sib_sti_inst.sib");
               end
               23: begin
                  if (_found_fail == 1) begin
               ...
               24: begin
                  $display($realtime, "ns:  Scan out verification pattern 1 from the scan register blockA_rtl_tessent_sib_sti_inst.sib");
               end
               25: begin
                  $display($realtime, "ns:  Activate selection of the following scan muxes:");
               end
               26: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_sib_sti_inst.scan_in_mux, selection 0: sib, ltest_en = 2'b10 -> scan_in_mux = ijtag_from_so");
               end
               27: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_sib_mbist_inst.scan_in_mux, selection 0: sib = 1'b0 -> scan_in_mux = ijtag_si");
               end
               28: begin
                  $display($realtime, "ns:  Scan in verification pattern 10 to the following scan registers:");
               end
               29: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_sib_sti_inst.sib");
               end
               30: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_sib_mbist_inst.sib");
               end
               31: begin
                  if (_found_fail == 1) begin
               ...
               32: begin
                  $display($realtime, "ns:  Scan out verification pattern 10 from the following scan registers:");
               end
               33: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_sib_mbist_inst.scan_in_mux, selection 1: sib = 1'b1 -> scan_in_mux = ijtag_from_so");
               end
               34: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.fromBistMux_0, selection 1: sib_0, BIST_SETUP_tdr[1], ChainBypassMode = 3'bxxx -> fromBistMux_0 = ENABLE_MEM_RESET_tdr");
               end
               35: begin
                  $display($realtime, "ns:  Scan in verification pattern 1011.. to the following scan registers:");
               end
               36: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.sib_0");
               end
               37: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.ENABLE_MEM_RESET_tdr");
               end
               38: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.REDUCED_ADDRESS_COUNT_tdr");
               end
               39: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIST_SELECT_TEST_DATA_tdr");
               end
               40: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIST_ALGO_MODE0_tdr");
               end
               41: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIST_ALGO_MODE1_tdr");
               end
               42: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIRA_EN_tdr");
               end
               43: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIST_DIAG_EN_tdr");
               end
               44: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.PRESERVE_FUSE_REGISTER_tdr");
               end
               45: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.CHECK_REPAIR_NEEDED_tdr");
               end
               46: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIST_ASYNC_RESET_tdr");
               end
               47: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.FL_CNT_MODE0_tdr");
               end
               48: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.FL_CNT_MODE1_tdr");
               end
               49: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIST_CLK_EN_tdr");
               end
               50: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.CHAIN_BYPASS_EN_tdr");
               end
               51: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIST_HOLD_tdr");
               end
               52: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.INVERT_ASYNC_TCK_tdr");
               end
               53: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.TCK_MODE_tdr");
               end
               54: begin
                  $display($realtime, "ns:   blockA_rtl_tessent_mbist_bap_inst.BIST_SETUP_tdr[2:0]");
               end
               55: begin
                  $display($realtime, "ns:  Scan out verification pattern 1011.. from the following scan registers:");
               end
               56: begin
                  if (_found_fail == 1) begin
               ...
               57: begin
                  if (_found_fail == 1) begin
                    $display($realtime, "ns: Previous scan out : pin ijtag_so , ICL register = blockA_rtl_tessent_mbist_bap_inst.ENABLE_MEM_RESET_tdr , design instance = blockA_rtl_tessent_mbist_bap_inst ");
                  end
               end
               58: begin
                  if (_found_fail == 1) begin
                    $display($realtime, "ns: Previous scan out : pin ijtag_so , ICL register = blockA_rtl_tessent_mbist_bap_inst.REDUCED_ADDRESS_COUNT_tdr , design instance = blockA_rtl_tessent_mbist_bap_inst ");
                  end
               end
               59: begin
                  if (_found_fail == 1) begin

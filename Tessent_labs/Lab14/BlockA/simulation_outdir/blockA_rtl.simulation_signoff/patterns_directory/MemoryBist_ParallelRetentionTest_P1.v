...
// Filename       : ./blockA_tsdb/patterns/blockA_rtl.patterns_signoff/MemoryBist_ParallelRetentionTest_P1.v
// Idstamp        : 2019.1:9779:6099:0:0000
// Date           : Wed Aug 14 12:11:41 2019
//
...
`ifdef MGC_CLOCK_MONITOR_CYCLES_MemoryBist_ParallelRetentionTest_P1
  `define MGC_CLOCK_MONITOR_CYCLES `MGC_CLOCK_MONITOR_CYCLES_MemoryBist_ParallelRetentionTest_P1
`else
...
`ifdef MGC_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT_MemoryBist_ParallelRetentionTest_P1
  `define MGC_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT `MGC_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT_MemoryBist_ParallelRetentionTest_P1
`else
        ...
        if (_write_DIAG_file == 1) begin
          if (_DIAG_file_header == 0) begin
            if ((_start_pat > -1) && (_end_pat > -1)) begin
              ...
              _diag_file = $fopen("MemoryBist_ParallelRetentionTest_P1.v.fail");
            end
        ...
        if (_write_MASK_file == 1) begin
          if (_MASK_file_header == 0) begin
            if ((_start_pat > -1) && (_end_pat > -1)) begin
              ...
              _mask_file = $fopen("MemoryBist_ParallelRetentionTest_P1.v.mask");
            end
            $fwrite(_mask_file, "%s\n%s\n", "type mask", "");
            _MASK_file_header = 1;
          end
...
`ifdef VCD
  initial begin
    $dumpfile("MemoryBist_ParallelRetentionTest_P1.v.dump");
    $dumpvars;
  end
`endif
...
`ifdef debussy
  initial begin
    $fsdbDumpfile("MemoryBist_ParallelRetentionTest_P1.v.fsdb");
    $fsdbDumpvars;
  end
`endif

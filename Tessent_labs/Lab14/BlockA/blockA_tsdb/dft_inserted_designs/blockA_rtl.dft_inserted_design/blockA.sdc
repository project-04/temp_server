...
#    tessent_constrain_blockA_mentor_ijtag_non_modal
#    tessent_constrain_blockA_non_modal
#    tessent_constrain_blockA_mentor_memory_bist_non_modal
#    tessent_constrain_blockA_mentor_memory_bist_modal
#    tessent_get_cells
#    tessent_get_flops
#    tessent_get_pins
...
proc tessent_set_default_variables {} {
  ...
  array set tessent_memory_bist_mapping {
    ...
    mbist1_m1 memA_interface_inst
    mbist1_m1_memory memA
  }
...
global time_unit_multiplier tessent_clock_mapping tessent_unmapped_functional_clocks
  ...
  set tessent_unmapped_functional_clocks [lsort -unique [concat $tessent_unmapped_functional_clocks [list clka]]]
}
proc tessent_constrain_blockA_mentor_ijtag_non_modal {} {  
  #
  ...
  if {[sizeof_collection [tessent_get_clocks $tessent_clock_mapping(tessent_tck) -quiet]] == 0} {
    create_clock [get_ports {ijtag_tck}] -period [expr $tessent_tck_period*$time_unit_multiplier] -name $tessent_clock_mapping(tessent_tck)
  }
  ...
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [get_ports "ijtag_ce"] -clock_fall
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [get_ports "ijtag_se"] -clock_fall
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [get_ports "ijtag_ue"]
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [get_ports "ijtag_sel"] -clock_fall
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [get_ports "ijtag_si"] -clock_fall
  set_output_delay $local_output_delay -clock $tessent_clock_mapping(tessent_tck) [get_ports "ijtag_so"]
  
  set scan_resource_sib_list {
    blockA_rtl_tessent_sib_sti_inst/to_enable_int*
  }
  set_multicycle_path -hold 1 \
      -from [tessent_get_cells $scan_resource_sib_list] 
  
}
proc tessent_constrain_blockA_non_modal {} {
  tessent_constrain_blockA_mentor_ijtag_non_modal
  tessent_constrain_blockA_mentor_memory_bist_non_modal
}
proc tessent_constrain_blockA_mentor_memory_bist_non_modal {} {  
  #
  ...
  ## Constraints for memory_bist interface 'memA_interface_inst'
...
proc tessent_constrain_blockA_mentor_memory_bist_modal {} {  
  #
  # Constraints for instrument mentor::memory_bist
  #
  ...
  set_false_path -from [remove_from_collection [all_inputs] [get_ports [list CLK ijtag_ce ijtag_se ijtag_si ijtag_tck ijtag_ue]] ] 
  set_false_path -to [remove_from_collection [all_outputs] [get_ports [list ijtag_so]] ] 
...
proc tessent_get_preserve_instances {select} {
  ...
  set scan_related_instance_list {
    blockA_rtl_tessent_sib_sti_inst
  }
  ...
  set icl_design_instance_list {
    ...
    blockA_rtl_tessent_sib_mbist_inst
    memA_interface_inst
  }
...
proc tessent_get_optimize_instances {} {
  set optimize_instance_list {
    blockA_rtl_tessent_mbist_bap_inst/blockA_rtl_tessent_mbist_controller_sib_inst0
    blockA_rtl_tessent_mbist_bap_inst/tdr_inst
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_ADD_FORMAT
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_ADD_GEN
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_ASYNC_INTERF
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_CTL_COMP
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_DATA_GEN
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_FSM
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_OPTION
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_POINTER_CNTRL
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_REPEAT_LOOP_CNTRL
    blockA_rtl_tessent_mbist_c1_controller_inst/MBISTPG_SIGNAL_GEN
    memA_interface_inst/MBISTPG_STATUS
    memA_interface_inst/MBIST_ColumnRedundancyAnalysis
    memA_interface_inst/MBIST_RowRedundancyAnalysis_INST
  }

...
//          Version: 2019.1
//       Created on: Wed Aug 14 12:11:38 IST 2019
//-------------------------------------------------
...
Module blockA {
   ...
   ClockPort CLK {
      Attribute tessent_clock_domain_labels = "clka CLK";
   ...
   ScanOutPort ijtag_so {
      Source blockA_rtl_tessent_sib_sti_inst.ijtag_so;
   }
   TCKPort ijtag_tck;
   ...
   Attribute icl_extraction_date = "Wed Aug 14 12:11:38 IST 2019";
   ...
   Instance blockA_rtl_tessent_mbist_bap_inst Of blockA_rtl_tessent_mbist_bap {
      InputPort reset = blockA_rtl_tessent_sib_sti_inst.to_ijtag_reset;
      InputPort ijtag_select = blockA_rtl_tessent_sib_mbist_inst.ijtag_to_sel;
      InputPort si = blockA_rtl_tessent_sib_sti_inst.to_ijtag_si;
      InputPort capture_en = blockA_rtl_tessent_sib_sti_inst.to_ijtag_ce;
      InputPort shift_en = blockA_rtl_tessent_sib_sti_inst.to_ijtag_se;
      InputPort update_en = blockA_rtl_tessent_sib_sti_inst.to_ijtag_ue;
      InputPort tck = blockA_rtl_tessent_sib_sti_inst.to_ijtag_tck;
      InputPort memory_bypass_en = 
          blockA_rtl_tessent_sib_sti_inst.ltest_to_mem_bypass_en;
      InputPort mcp_bounding_en = 
          blockA_rtl_tessent_sib_sti_inst.ltest_to_mcp_bounding_en;
      InputPort ltest_en = blockA_rtl_tessent_sib_sti_inst.ltest_to_en;
   ...
   Instance blockA_rtl_tessent_mbist_c1_controller_inst Of 
      ...
      InputPort LV_TM = blockA_rtl_tessent_mbist_bap_inst.ltest_to_en;
      InputPort MEM_BYPASS_EN = 
          blockA_rtl_tessent_mbist_bap_inst.memory_bypass_to_en;
      InputPort MCP_BOUNDING_EN = 
          blockA_rtl_tessent_mbist_bap_inst.mcp_bounding_to_en;
      ...
      InputPort MEM0_BIST_COLLAR_SO = memA_interface_inst.BIST_SO;
      Attribute tessent_design_instance = 
          "blockA_rtl_tessent_mbist_c1_controller_inst";
   }
   Instance blockA_rtl_tessent_sib_mbist_inst Of blockA_rtl_tessent_sib_2 {
      InputPort ijtag_reset = blockA_rtl_tessent_sib_sti_inst.to_ijtag_reset;
      InputPort ijtag_sel = blockA_rtl_tessent_sib_sti_inst.ijtag_to_sel;
      InputPort ijtag_si = blockA_rtl_tessent_sib_sti_inst.to_ijtag_si;
      InputPort ijtag_ce = blockA_rtl_tessent_sib_sti_inst.to_ijtag_ce;
      InputPort ijtag_se = blockA_rtl_tessent_sib_sti_inst.to_ijtag_se;
      InputPort ijtag_ue = blockA_rtl_tessent_sib_sti_inst.to_ijtag_ue;
      InputPort ijtag_tck = blockA_rtl_tessent_sib_sti_inst.to_ijtag_tck;
      InputPort ijtag_from_so = blockA_rtl_tessent_mbist_bap_inst.so;
      Attribute tessent_design_instance = "blockA_rtl_tessent_sib_mbist_inst";
   }
   Instance blockA_rtl_tessent_sib_sti_inst Of blockA_rtl_tessent_sib_1 {
      ...
      InputPort ijtag_from_so = blockA_rtl_tessent_sib_mbist_inst.ijtag_so;
      ...
      Attribute tessent_design_instance = "blockA_rtl_tessent_sib_sti_inst";
   }
   Instance memA Of SYNC_8192X32_BISR {
      InputPort A[12] = memA_interface_inst.A[12];
      InputPort A[11] = memA_interface_inst.A[11];
      InputPort A[10] = memA_interface_inst.A[10];
      InputPort A[9] = memA_interface_inst.A[9];
      InputPort A[8] = memA_interface_inst.A[8];
      InputPort A[7] = memA_interface_inst.A[7];
      InputPort A[6] = memA_interface_inst.A[6];
      InputPort A[5] = memA_interface_inst.A[5];
      InputPort A[4] = memA_interface_inst.A[4];
      InputPort A[3] = memA_interface_inst.A[3];
      InputPort A[2] = memA_interface_inst.A[2];
      InputPort A[1] = memA_interface_inst.A[1];
      InputPort A[0] = memA_interface_inst.A[0];
      InputPort CLK = CLK;
      Attribute tessent_design_instance = "memA";
   }
   Instance memA_interface_inst Of blockA_rtl_tessent_mbist_c1_interface_m1 {
      InputPort BIST_CLK = CLK;
      ...
      Attribute tessent_design_instance = "memA_interface_inst";
   }
}

// instanced as blockA.blockA_rtl_tessent_mbist_bap_inst
...
// instanced as blockA.blockA_rtl_tessent_mbist_c1_controller_inst
...
// instanced as blockA.blockA_rtl_tessent_sib_mbist_inst
Module blockA_rtl_tessent_sib_2 {
   // ICL module read from source on or near line 17 of file '/home/susmita/MBIST_exercise1/MBIST/BlockA/blockA_tsdb/instruments/blockA_rtl_ijtag.instrument/blockA_rtl_tessent_sib_2.icl'
   ResetPort ijtag_reset {
      ActivePolarity 0;
   }
   SelectPort ijtag_sel;
...
// instanced as blockA.blockA_rtl_tessent_sib_sti_inst
Module blockA_rtl_tessent_sib_1 {
   // ICL module read from source on or near line 17 of file '/home/susmita/MBIST_exercise1/MBIST/BlockA/blockA_tsdb/instruments/blockA_rtl_ijtag.instrument/blockA_rtl_tessent_sib_1.icl'
   ResetPort ijtag_reset {
      ActivePolarity 0;
   }
   SelectPort ijtag_sel;
...
// instanced as blockA.memA_interface_inst

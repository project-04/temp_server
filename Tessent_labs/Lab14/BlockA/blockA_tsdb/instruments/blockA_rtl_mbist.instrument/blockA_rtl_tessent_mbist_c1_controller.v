...
module blockA_rtl_tessent_mbist_c1_controller (
    ...
    BIST_COLLAR_EN0                                ,          // Enable for interface m1
    CHKBCI_PHASE                                   ,       
    ...
    input MBIST_RA_PRSRV_FUSE_VAL;
    wire  MBIST_RA_PRSRV_FUSE_VAL_SYNC;
    output BIST_CLEAR_BIRA;
    ...
    output           BIST_TESTDATA_SELECT_TO_COLLAR;
    input            MEM_BYPASS_EN;
    ...
    output           ERROR_CNT_ZERO;
    input [1:0]      FL_CNT_MODE;
    input            MBISTPG_BIRA_EN;
    input            CHECK_REPAIR_NEEDED;
    output           BIST_COLLAR_DIAG_EN;
    output           BIST_COLLAR_BIRA_EN;
    ...
    wire             BIST_CLK_INT; 
    input            BIST_CLK_EN;
    wire             BIST_CLK_EN_INT;
    wire             BIST_CLK_EN_RST;
    wire             BIST_CLK_EN_RETIME1_IN;
    wire             BIST_CLK_EN_RETIME1;
    wire             BIST_CLK_EN_RETIME2_IN;
    reg              BIST_CLK_EN_RETIME2;
    input            BIST_SI;
    output           MBISTPG_SO;
    input            BIST_SHIFT;
    wire             BIST_SHIFT_INT;
...
output               BIST_SHIFT_BIRA_COLLAR;
output               BIST_IO_RA_PRSRV_FUSE_VAL_TO_COLLAR;
wire RA_BIRA_SO;
...
//------------------------
//-- BIST_CLK_EN Retiming --
//------------------------
    assign BIST_CLK_EN_RST          = ~MBISTPG_ASYNC_RESETN;
    assign BIST_CLK_EN_RETIME1_IN   = BIST_CLK_EN;
    // Posedge retiming cell
    blockA_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL_CLK_EN ( 
        .rn          (MBISTPG_ASYNC_RESETN         ), // i
        .clk        ( BIST_CLK     ), // i
        .d          ( BIST_CLK_EN_RETIME1_IN      ), // i
        .q          ( BIST_CLK_EN_RETIME1         )  // o
    ); 
    assign BIST_CLK_EN_RETIME2_IN   = BIST_CLK_EN_RETIME1;
 
    // Posedge stage
    // synopsys async_set_reset "BIST_CLK_EN_RST"
    always @ (posedge BIST_CLK or posedge BIST_CLK_EN_RST) begin
        if (BIST_CLK_EN_RST)
            BIST_CLK_EN_RETIME2     <= 1'b0;
        else
            BIST_CLK_EN_RETIME2     <= BIST_CLK_EN_RETIME2_IN;
    end
    assign BIST_CLK_EN_INT          = BIST_CLK_EN_RETIME2;
    cgand tessent_persistent_cell_GATING_BIST_CLK (
        .CK         ( BIST_CLK                    ),
        .TE         ( 1'b0         ),
        .FE         ( BIST_CLK_EN_INT & ~MCP_BOUNDING_EN         ),
        .GCK        ( BIST_CLK_INT                )
    );
 
    and02 tessent_persistent_cell_AND_MBIST_RA_PRSRV_FUSE_VAL_SYNC (
        .A0         ( MBIST_RA_PRSRV_FUSE_VAL                    ),
        .A1         ( BIST_ON                                    ),
        .Y          ( MBIST_RA_PRSRV_FUSE_VAL_SYNC               )
    );

    and02 tessent_persistent_cell_AND_MBISTPG_BIRA_EN_SYNC (
        .A0         ( MBISTPG_BIRA_EN                            ),
        .A1         ( BIST_ON                                    ),
        .Y          ( MBISTPG_BIRA_EN_SYNC                       )
    );

    and02 tessent_persistent_cell_AND_MBISTPG_MEM_RST_SYNC (
        .A0         ( MBISTPG_MEM_RST                            ),
        .A1         ( BIST_ON                                    ),
        .Y          ( MBISTPG_MEM_RST_SYNC                       )
    );

    and02 tessent_persistent_cell_AND_FL_CNT_MODE0_SYNC (
        .A0         ( FL_CNT_MODE[0]                             ),
        .A1         ( BIST_ON                                    ),
        .Y          ( FL_CNT_MODE0_SYNC                          )
    );
    ...
    blockA_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL_TESTDATA_SELECT ( 
        .rn                         (MBISTPG_ASYNC_RESETN         ), // i
        .clk        ( BIST_CLK_INT                ), // i
    ...
    assign BIST_CLEAR_BIRA_INT      = RESET_REG_SETUP1 & ~GO_EN;
    ...
    and02 tessent_persistent_cell_AND_BIST_SI_SYNC (
        .A0         ( BIST_SI                                    ),
        .A1         ( BIST_SHIFT_SYNC                            ),
        .Y          ( BIST_SI_SYNC                               )
    );
    ...
    and02 tessent_persistent_cell_AND_BIST_SETUP_SYNC0 (
        .A0         ( BIST_SETUP_INT[0]                          ),
        .A1         ( BIST_ON                                    ),
        .Y          ( BIST_SETUP_SYNC[0]                         )
    );

    buf02 tessent_persistent_cell_BIST_SETUP_SYNC1 (
        .A           (BIST_ON),
        .Y           (BIST_SETUP_SYNC[1])
    );
    and02 tessent_persistent_cell_AND_BIST_SETUP_SYNC2 (
        .A0         ( BIST_SETUP_INT[2]                          ),
        .A1         ( BIST_ON                                    ),
        .Y          ( BIST_SETUP_SYNC[2]                         )
    );
    ...
    and02 tessent_persistent_cell_AND_MBISTPG_BIRA_SETUP_SYNC (
        .A0         ( MBISTPG_BIRA_SETUP_TO_SYNC                 ),
        .A1         ( BIST_SHIFT_SYNC                            ),
        .Y          ( MBISTPG_BIRA_SETUP_SYNC                    )
    );

    and02 tessent_persistent_cell_AND_SHORT_SETUP_SYNC (
        .A0         ( ~BIST_SETUP_INT[2] & ~BIST_SETUP_INT[1] & ~BIST_SETUP_INT[0]             ),
        .A1         ( BIST_SHIFT_SYNC                            ),
        .Y          ( SHORT_SETUP_SYNC                           )
    );
    ...
    buf02 tessent_persistent_cell_MBISTPG_DONE (
        .A           (BIST_DONE_PIPE1),
        .Y           (MBISTPG_DONE)
    );
    ...
    assign BIST_RUN_TO_COLLAR0_PRE                 = BIST_RUN_INT & MEM_SELECT_REG_INT[0];
    assign BIST_COLLAR_EN0_PRE      = BIST_RUN_INT & MEM_SELECT_REG_INT[0] ;
 
 
    blockA_rtl_tessent_mbist_c1_controller_async_interf MBISTPG_ASYNC_INTERF ( 
       ...
       .MBISTPG_BIRA_SETUP          (MBISTPG_BIRA_SETUP_SYNC     ),
       .BIST_SHIFT_BIRA             (BIST_SHIFT_BIRA             ),
       .BIST_SHIFT_SHORT            (BIST_SHIFT_SHORT            )
    );
    assign BIST_HOLD_INT = BIST_HOLD;
    
    blockA_rtl_tessent_mbist_c1_controller_option MBISTPG_OPTION (
       .BIST_CLK                    ( BIST_CLK_INT                              ),
       .BIST_EN                     (MBISTPG_EN_INT              ),
    ...
    buf02 tessent_persistent_cell_BIST_ON (
        .A           (BIST_ON_TO_BUF),
        .Y           (BIST_ON)
    );    
    ...
    blockA_rtl_tessent_mbist_c1_controller_fsm MBISTPG_FSM (
       .BIST_CLK                    (BIST_CLK_INT                ), 
       .BIST_ON                     (BIST_ON_TO_BUF              ),
       .BIST_HOLD_R                 (BIST_HOLD_R                 ),
       .NEXT_ALGO                   (NEXT_ALGO                   ),
    ...
    buf02 tessent_persistent_cell_BIST_RUN (
        .A           (BIST_RUN_INT),
        .Y           (BIST_RUN)
    );    
    ...
    // DIAGNOSIS MODE
    //----------------
    and02 tessent_persistent_cell_AND_MBISTPG_DIAG_EN_GATED (
        .A0         ( MBISTPG_DIAG_EN                            ),
        .A1         ( BIST_ON                                    ),
...
assign CMP_EN = CMP_EN_INT;
    ...
    //------------------------
    and02 tessent_persistent_cell_AND_MBISTPG_REDUCED_ADDR_CNT_EN_SYNC (
        .A0         ( MBISTPG_REDUCED_ADDR_CNT_EN                ),
        .A1         ( BIST_ON                                    ),
    ...
    //------------------------
    and02 tessent_persistent_cell_AND_MBISTPG_ALGO_MODE_SYNC0 (
        .A0         ( MBISTPG_ALGO_MODE[0]                       ),
        .A1         ( BIST_ON                                    ),
        .Y          ( MBISTPG_ALGO_MODE_SYNC[0]                  )
    );

    and02 tessent_persistent_cell_AND_MBISTPG_ALGO_MODE_SYNC1 (
        .A0         ( MBISTPG_ALGO_MODE[1]                       ),
        .A1         ( BIST_ON                                    ),
    ...
    blockA_rtl_tessent_mbist_c1_controller_pointer_cntrl MBISTPG_POINTER_CNTRL ( 
       .BIST_CLK                                   ( BIST_CLK_INT                              ),
    ...
    blockA_rtl_tessent_mbist_c1_controller_add_gen MBISTPG_ADD_GEN (
       .BIST_CLK                    (BIST_CLK_INT                ),
       .BIST_RUN                    (BIST_RUN                    ),
       .RESET_REG_DEFAULT_MODE      (RESET_REG_DEFAULT_MODE      ),
       .BIST_ASYNC_RESETN           (MBISTPG_ASYNC_RESETN        ),
    ...
    blockA_rtl_tessent_mbist_c1_controller_add_format MBISTPG_ADD_FORMAT (
       .Y_ADDRESS                   (Y_ADDRESS                   ),
       .X_ADDRESS                   (X_ADDRESS                   ),
    ...
    buf02 tessent_persistent_cell_Y1_MINMAX_TRIGGER(
        .A           (Y1_MINMAX_TRIGGER_OUT),
        .Y           (Y1_MINMAX_TRIGGER)
    );    
    buf02 tessent_persistent_cell_X1_MINMAX_TRIGGER(
        .A           (X1_MINMAX_TRIGGER_OUT),
        .Y           (X1_MINMAX_TRIGGER)
    );    

    assign SIGNAL_GEN_SI            = ADD_GEN_SO;
    blockA_rtl_tessent_mbist_c1_controller_signal_gen MBISTPG_SIGNAL_GEN (       
       .BIST_CLK                                   ( BIST_CLK_INT                              ),
       .BIST_ASYNC_RESETN                          ( MBISTPG_ASYNC_RESETN       ),
       .SI                                         (SIGNAL_GEN_SI                              ),
       .BIST_SHIFT_SHORT                           (BIST_SHIFT_SHORT                           ),
    ...
    blockA_rtl_tessent_mbist_c1_controller_data_gen MBISTPG_DATA_GEN (
       //inputs
       .BIST_CLK                    (BIST_CLK_INT                ),
       .BIST_HOLD                   (BIST_HOLD_R_INT             ),
       .BIST_ASYNC_RESETN           (MBISTPG_ASYNC_RESETN        ), 
    ...
    blockA_rtl_tessent_mbist_c1_controller_repeat_loop_cntrl MBISTPG_REPEAT_LOOP_CNTRL (
       .BIST_CLK                                   ( BIST_CLK_INT               ),
       .RESET_REG_SETUP1                           (RESET_REG_SETUP1            ),
       .RESET_REG_DEFAULT_MODE                     (RESET_REG_DEFAULT_MODE      ),
       .LOOP_CMD                                   (LOOP_CMD                    ),
    ...
    buf02 tessent_persistent_cell_LOOPCOUNTMAX_TRIGGER (
        .A           (LOOPCOUNTMAX_TRIGGER_INT),
        .Y           (LOOPCOUNTMAX_TRIGGER)
    );    
    buf02 tessent_persistent_cell_INH_LAST_ADDR_CNT (
    ...
    wire RAM_COLLAR_BIRA_REPAIRABLE;
    assign RAM_COLLAR_BIRA_REPAIRABLE              = BIST_COLLAR_GO
;
 
    assign COLLAR_GO                = BIRA_EN_R ? RAM_COLLAR_BIRA_REPAIRABLE : BIST_COLLAR_GO;
    assign RAM_COLLAR_GO            = BIST_COLLAR_GO;
    wire RAM_COLLAR_BIRA_REPAIR_NEEDED;
    assign RAM_COLLAR_BIRA_REPAIR_NEEDED           = BIST_COLLAR_GO
;
    assign MBISTPG_GO_INT           = CHECK_REPAIR_NEEDED ? RAM_COLLAR_BIRA_REPAIR_NEEDED: (MONITOR_CMP_STAT) ? RAM_COLLAR_GO : GO_EN & COLLAR_GO;
reg MBISTPG_GO_R;
wire MBISTPG_GO_M;
wire CMP_STAT_MODE;
    ...
    always @(posedge BIST_CLK_INT or negedge MBISTPG_ASYNC_RESETN) begin
      ...
      if ( ~GO_EN ) begin
        MBISTPG_GO_R <= BIST_CLEAR_BIRA_INT;
      end else begin
        MBISTPG_GO_R <= MBISTPG_GO_INT & MBISTPG_GO_R;
      end
    end
    assign CMP_STAT_MODE = BIST_DIAG_EN & ~BIRA_EN_R & ~BIST_STOP_ON_ERROR_EN_INT;
    assign MBISTPG_GO_M = (CMP_STAT_MODE&~CHECK_REPAIR_NEEDED) ? MBISTPG_GO_INT : (CHECK_REPAIR_NEEDED ? MBISTPG_GO_INT : MBISTPG_GO_R);
 
    buf02 tessent_persistent_cell_MBISTPG_GO (
        .A           ( MBISTPG_GO_M                ),
        .Y           ( MBISTPG_GO   )
    );
    ...
    //---------------------------------------
    assign TO_COLLAR_SI_MUX_INPUT0 = (MBISTPG_BIRA_SETUP_SYNC) ? BIST_SI_SYNC : REPEAT_LOOP_CNTRL_SO;
    ...
    assign MBISTPG_SO               = (MBISTPG_BIRA_SETUP_TO_SYNC) ? MEM0_BIST_COLLAR_SO : CTL_COMP_SO;
        
 
 
wire PriorityColumn;
assign PriorityColumn = 1'b1;
assign RA_BIRA_SO = MEM0_BIST_COLLAR_SO;
    //---------------------------
    // BIRA Preserve Mode Enable
    //---------------------------
 
    assign BIRA_CONFIG_SO = BIRA_CONFIG[1];
    assign BIST_IO_RA_PRSRV_FUSE_VAL_TO_COLLAR = MBISTPG_PRESERVE_BIRA ;
   assign MBISTPG_PRESERVE_BIRA     = BIST_ON & BIRA_CONFIG[0];
// synopsys async_set_reset "MBISTPG_ASYNC_RESETN"
...
always @ (posedge BIST_CLK_INT or negedge MBISTPG_ASYNC_RESETN) begin
    ...
    if (BIST_SHIFT_SHORT) begin 
        BIRA_CONFIG <=  {BIRA_CONFIG[0],MEM0_BIST_COLLAR_SO};
    end
    else begin
        if (MBISTPG_RESET_BIRA_CONFIG_INT) begin
            BIRA_CONFIG <=  {1'b0,MBIST_RA_PRSRV_FUSE_VAL_SYNC};
        end
    end
end    
    blockA_rtl_tessent_mbist_c1_controller_ctl_comp MBISTPG_CTL_COMP (
...
endmodule // blockA_rtl_tessent_mbist_c1_controller


/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_ctl_comp
...
assign FL1_RETIME1_IN = FL1; 
    blockA_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL_FL1 ( 
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_ctl_comp
 
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_async_interf
...
module blockA_rtl_tessent_mbist_c1_controller_async_interf ( 
    ...
    input            MBISTPG_BIRA_SETUP;
    output           BIST_SHIFT_BIRA;
    reg              ASYNC_INTERF_R;
    ...
    and02 tessent_persistent_cell_AND_BIST_SHIFT_SYNC (
        .A0         ( TCK_PULSE                                  ),
        .A1         ( BIST_EN & BIST_SHIFT                       ),
        .Y          ( BIST_SHIFT_SYNC                            )
    );
 
    and02 tessent_persistent_cell_AND_BIST_SETUP_SYNC_WITH_SHIFT0 (
        .A0         ( BIST_SHIFT_SYNC                            ),
        .A1         ( BIST_SETUP[0]                              ),
        .Y          ( BIST_SETUP_SYNC_WITH_SHIFT[0]              )
    );
 
    and02 tessent_persistent_cell_AND_BIST_SETUP_SYNC_WITH_SHIFT1 (
        .A0         ( BIST_SHIFT_SYNC                            ),
        .A1         ( BIST_SETUP[1]                              ),
        .Y          ( BIST_SETUP_SYNC_WITH_SHIFT[1]              )
    );
 
    assign BIST_SHIFT_LONG          = BIST_SHIFT_SYNC & ~BIST_SETUP_SYNC_WITH_SHIFT[1] & BIST_SETUP_SYNC_WITH_SHIFT[0] & ~MBISTPG_BIRA_SETUP ;
 
    assign BIST_SHIFT_SHORT         = BIST_SHIFT_SYNC & ~BIST_SETUP_SYNC_WITH_SHIFT[1] & ~MBISTPG_BIRA_SETUP ;

    assign BIST_SHIFT_BIRA          = BIST_SHIFT_SYNC & MBISTPG_BIRA_SETUP;
 
//------------------
//-- TCK Retiming --
//------------------
    assign TCK_RETIME1_RST          = ~BIST_ASYNC_RESETN;
    and02 tessent_persistent_cell_AND_TCK_RETIME1_IN (
        .A0         ( TCK                                        ),
        .A1         ( BIST_EN                                    ),
        .Y          ( TCK_RETIME1_IN                             )
    );
    ...
    // Posedge retiming cell
    blockA_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL_TCK ( 
        .rn                         (BIST_ASYNC_RESETN            ), // i
        .clk        ( BIST_CLK     ), // i
        .d          ( TCK_RETIME1_IN              ), // i
        .q          ( TCK_RETIME1  )  // o
    ...
    assign ASYNC_INTERF_R_IN        = TCK_RETIME1 ;
    // synopsys async_set_reset "BIST_ASYNC_RESETN"
    always @ (posedge BIST_CLK or negedge BIST_ASYNC_RESETN) begin
        if (~BIST_ASYNC_RESETN)
            ASYNC_INTERF_R          <= 1'b0;
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_async_interf
 
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_option
...
//-- Main Code --
//---------------
    and02 tessent_persistent_cell_AND_DEFAULT_MODE (
        .A0         ( ~BIST_SETUP[0]                             ),
        .A1         ( BIST_ON_INT                                ),
        .Y          ( DEFAULT_MODE                               )
    );
...
//----------------------
    ...
    blockA_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL ( 
        .rn                         (BIST_ASYNC_RESETN            ), // i
        .clk        ( BIST_CLK     ), // i
...
//------------------------
    ...
    // Posedge retiming cell
    blockA_rtl_tessent_posedge_synchronizer_reset tessent_persistent_cell_MBIST_NTC_RETIMING_CELL_HOLD ( 
        .rn                         (BIST_ASYNC_RESETN            ), // i
        .clk        ( BIST_CLK     ), // i
        .d          ( BIST_HOLD_RETIME1_IN        ), // i
        .q          ( BIST_HOLD_RETIME1           )  // o
    ); 
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_option
 
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_pointer_cntrl
...
// NEXT_POINTER persistent buffers {{{
    buf02 tessent_persistent_cell_NEXT_POINTER0 (
        .A           (NEXT_POINTER_TO_BUF[0]      ),
        .Y           (NEXT_POINTER[0]             )
    );    
    buf02 tessent_persistent_cell_NEXT_POINTER1 (
        .A           (NEXT_POINTER_TO_BUF[1]      ),
        .Y           (NEXT_POINTER[1]             )
    );    
    buf02 tessent_persistent_cell_NEXT_POINTER2 (
        .A           (NEXT_POINTER_TO_BUF[2]      ),
        .Y           (NEXT_POINTER[2]             )
    );    
    buf02 tessent_persistent_cell_NEXT_POINTER3 (
        .A           (NEXT_POINTER_TO_BUF[3]      ),
        .Y           (NEXT_POINTER[3]             )
    );    
    buf02 tessent_persistent_cell_NEXT_POINTER4 (
...
// NEXT_POINTER persistent buffers }}}
    ...
    assign NEXT_POINTER_TO_BUF = (MEM_RST == 1'b1 & INST_POINTER == 5'b00100) ? 5'b01100 :
    ...
    assign LOOP_TRIGGERS            = {COUNTERA_ENDCOUNT_TRIGGER,
      ...
      always @(INST_POINTER or ALGO_MODE or NEXT_STATE_TRUE or BIST_RUN or MEM_RST) begin
         case (ALGO_MODE)
             ...
             2'b11: LAST_STATE_INT                 = (BIST_RUN & NEXT_STATE_TRUE && (INST_POINTER == 5'b01000)); 
          endcase
      end
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_pointer_cntrl
 
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_add_format
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_add_format
 
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_add_gen
...
//---------------------------------
  ...
  // Instantiate X_ADD_CNT persistent buffers {{{
    buf02 tessent_persistent_cell_X_ADD_CNT_0 (
        .A           (X_ADD_CNT_TO_BUF[0]),
        .Y           (X_ADD_CNT[0])
    );    
    buf02 tessent_persistent_cell_X_ADD_CNT_1 (
        .A           (X_ADD_CNT_TO_BUF[1]),
        .Y           (X_ADD_CNT[1])
    );    
    buf02 tessent_persistent_cell_X_ADD_CNT_2 (
        .A           (X_ADD_CNT_TO_BUF[2]),
        .Y           (X_ADD_CNT[2])
    );    
    buf02 tessent_persistent_cell_X_ADD_CNT_3 (
        .A           (X_ADD_CNT_TO_BUF[3]),
        .Y           (X_ADD_CNT[3])
    );    
    buf02 tessent_persistent_cell_X_ADD_CNT_4 (
        .A           (X_ADD_CNT_TO_BUF[4]),
        .Y           (X_ADD_CNT[4])
    );    
    buf02 tessent_persistent_cell_X_ADD_CNT_5 (
        .A           (X_ADD_CNT_TO_BUF[5]),
        .Y           (X_ADD_CNT[5])
    );    
    buf02 tessent_persistent_cell_X_ADD_CNT_6 (
        .A           (X_ADD_CNT_TO_BUF[6]),
        .Y           (X_ADD_CNT[6])
    );    
    buf02 tessent_persistent_cell_X_ADD_CNT_7 (
        .A           (X_ADD_CNT_TO_BUF[7]),
        .Y           (X_ADD_CNT[7])
    );    
    buf02 tessent_persistent_cell_X_ADD_CNT_8 (
  ...
  // Instantiate Y_ADD_CNT persistent buffers {{{
    buf02 tessent_persistent_cell_Y_ADD_CNT_0 (
        .A           (Y_ADD_CNT_TO_BUF[0]),
        .Y           (Y_ADD_CNT[0])
    );    
    buf02 tessent_persistent_cell_Y_ADD_CNT_1 (
        .A           (Y_ADD_CNT_TO_BUF[1]),
        .Y           (Y_ADD_CNT[1])
    );    
    buf02 tessent_persistent_cell_Y_ADD_CNT_2 (
        .A           (Y_ADD_CNT_TO_BUF[2]),
        .Y           (Y_ADD_CNT[2])
    );    
    buf02 tessent_persistent_cell_Y_ADD_CNT_3 (
...
//------------------------------------
    assign           AY_ADD_WIRE    = 4'b0000; // Algorithm: SMARCHCHKB
...
//------------------------------------
    assign           BY_ADD_WIRE    = 4'b0000; // Algorithm: SMARCHCHKB
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_add_gen
  
 
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_fsm
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_fsm
 
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_signal_gen
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_signal_gen
     
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_repeat_loop_cntrl
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_repeat_loop_cntrl
 
 
/*------------------------------------------------------------------------------
     Module      :  blockA_rtl_tessent_mbist_c1_controller_data_gen
...
//----------------------------
   ...
   // through this buffer.
   //
    buf02 tessent_persistent_cell_EN_ADDR_BIT_INVERSION (
...
//---------------------------
    ...
    assign X_ADDR_BIT_SEL_WIRE     = 1'b1; // Algorithm: SMARCHCHKB
    // synopsys async_set_reset "BIST_ASYNC_RESETN"
    always @ (posedge BIST_CLK or negedge BIST_ASYNC_RESETN) begin
       if (~BIST_ASYNC_RESETN)
    ...
    assign Y_ADDR_BIT_SEL_WIRE     = 1'b0; // Algorithm: SMARCHCHKB
...
endmodule // blockA_rtl_tessent_mbist_c1_controller_data_gen

class axi_xtn extends uvm_sequence_item;
	...
	rand bit [7:0] 	AWID; //i
	rand bit [31:0] AWADDR; //i
	rand bit [3:0] 	AWLEN; //i
	rand bit [2:0] 	AWSIZE; //i
	rand bit [1:0] 	AWBURST; //i
	...
	rand bit [7:0] 	ARID; //i
	rand bit [31:0] ARADDR; //i
	rand bit [3:0] 	ARLEN; //i
	rand bit [2:0] 	ARSIZE; //i
	rand bit [1:0] 	ARBURST; //i
	...
	function void calc_waddr();
		...
		int next_addr		= (wrap_boundary+(no_wbytes*burst_len)); 

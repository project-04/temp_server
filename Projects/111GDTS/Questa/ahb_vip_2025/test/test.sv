class test extends uvm_test;
	...
	function void config_data;
				...
				begin
					...
					foreach(sagt_cfg[i])
						begin
							...
							if(!uvm_config_db#(virtual sl_if)::get(this,"",$sformatf("vif[%0d]",i),sagt_cfg[i].vif))
			...
			rst_cfg=ahb_rst_agent_config::type_id::create("rst_cfg");
					if(!uvm_config_db#(virtual ahb_rst_if)::get(this,"","rst_vif",rst_cfg.vif))
					     `uvm_fatal("TEST","CANNOT GET SAGT_CFG.VIF CHECK IF U HAVE SET IT?")
...
class test1 extends test;
	...
	function void build_phase(uvm_phase phase);
		super.build_phase(phase);
		rst=ahb_rst_seq::type_id::create("rst");

 ...
 task virtual_sequence_base::body();
   ...
   `uvm_info(get_type_name(),"virtual seq base body",UVM_LOW)
...
//=======================================================================
 ...
 class ahb_vseq1 extends virtual_sequence_base;
   `uvm_object_utils(ahb_vseq1)
   //properties
   ahb_seq1 ahb_vseqh;
   //methods 
   extern function new(string name="ahb_vseq1");
   extern task body();
 endclass
 //------------------------------ new ------------------------------
 function ahb_vseq1::new(string name="ahb_vseq1");
   super.new(name);
 endfunction
 //----------------------------- body ---------------------------------
 task ahb_vseq1::body();
   ...
   if(env_cfg.has_ahb_agent)
     begin
       ahb_vseqh=ahb_seq1::type_id::create("ahb_vseqh");
     end
   fork
     begin
       ahb_vseqh.start(ahb_seqrh[0]);
 ...
 endtask
 //=============================================================
 class axi_burst_vseq1 extends virtual_sequence_base;
   `uvm_object_utils(axi_burst_vseq1)
   //properties
   axi_burst_seq1 axi_burst_vseqh1;
   //methods 
   extern function new(string name="axi_burst_vseq1");
   extern task body();
 endclass
 //------------------------------ new ------------------------------
 function axi_burst_vseq1::new(string name="axi_burst_vseq1");
   super.new(name);
 endfunction
 //----------------------------- body ---------------------------------
 task axi_burst_vseq1::body();
   super.body();
   if(env_cfg.has_axi_agent)
     begin
       axi_burst_vseqh1=axi_burst_seq1::type_id::create("axi_burst_vseqh1");
     end
   fork
     begin
       axi_burst_vseqh1.start(axi_seqrh[0]);
     end
   join
 endtask

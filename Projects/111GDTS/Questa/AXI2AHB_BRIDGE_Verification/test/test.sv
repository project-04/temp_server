 class base_test extends uvm_test;
   ...
   extern function void config_method();
 endclass
 //--------------------------- new ---------------------------
 ...
 //--------------------------- config axi2ahb ----------------------------
 function void base_test::config_method();
   ...
   this.randomize() with {length.size==no_of_transactions;};
 ...
 class axi_test_write_burst1 extends base_test;
   `uvm_component_utils(axi_test_write_burst1)
   axi_burst_vseq axi_burst_vseqh;
   ahb_vseq ahb_vseqh;
   ...
   extern function new(string name="axi_test_write_burst1",uvm_component parent);
   extern function void build_phase(uvm_phase phase);
   extern task run_phase(uvm_phase phase);
 endclass
 //--------------------------------------- new ------------------------------------
 function axi_test_write_burst1::new(string name="axi_test_write_burst1",uvm_component parent);
   super.new(name,parent);
 endfunction
 //--------------------------------- build_phase -------------------------------
 function void axi_test_write_burst1::build_phase(uvm_phase phase);
   super.no_of_transactions=1;
   super.build_phase(phase);
 endfunction
 //---------------------------- run phase ------------------------------
 task axi_test_write_burst1::run_phase(uvm_phase phase);
   begin
     phase.raise_objection(this);
     repeat(no_of_transactions)
       begin

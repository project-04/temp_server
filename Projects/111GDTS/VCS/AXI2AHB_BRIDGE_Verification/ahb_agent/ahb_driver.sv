...
Description             :       ahb driver for axi2ahb bridge verification
...
*********************************************************************************************/
 ...
 function void ahb_driver :: build_phase(uvm_phase phase);
   ...
   `uvm_info(get_type_name(),"ahb driver build_phase",UVM_HIGH)
 endfunction
 //---------------------------connect phase------------------------------
 function void ahb_driver::connect_phase(uvm_phase phase);
   ...
   `uvm_info(get_type_name(),"ahb driver connect_phase",UVM_HIGH)
 endfunction
 //----------------------------Run phase--------------------------------------
 task ahb_driver::run_phase(uvm_phase phase);
   ...
   `uvm_info(get_type_name(),"ahb driver run_phase",UVM_HIGH)
 endtask
 //----------------------------- send to dut ---------------------------------
 task ahb_driver::send_to_dut(ahb_trans xtn);
   `uvm_info(get_type_name(),"inside task send to dut run_phase",UVM_HIGH)

...
Filename                :       axi_rst_driver.sv   

module Name             :       axi_rst_driver

Description             :       axi reset driver for axi2ahb bridge verification
...
*********************************************************************************************/
 ...
 function void axi_rst_driver::connect_phase(uvm_phase phase);
   ...
   vif=rst_cfg.vif;
   `uvm_info(get_type_name(),"axi rst driver connecr_phase",UVM_HIGH)
 endfunction
 //--------------------------- run phase ----------------------------------
 task axi_rst_driver::run_phase(uvm_phase phase);
   ...
   `uvm_info(get_type_name(),"axi rst drivr run_phase",UVM_HIGH)
 endtask
 //------------------------------ send to dut ---------------------------

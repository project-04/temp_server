...
Filename                :       ahb_rst_monitor.sv   

module Name             :       ahb_rst_monitor

Description             :       ahb reset monitor for axi2ahb bridge verification
...
*********************************************************************************************/
 ...
 task ahb_rst_monitor::collect();
   ...
   @(vif.ahb_rst_mon_cb); 
   $display("&&&&&&&&&&&&&&&&& %d",vif.ahb_rst_mon_cb.hresetn);

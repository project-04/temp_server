...
Description             :       environment for axi2ahb bridge verification
...
*********************************************************************************************/
 ...
 function void environment::build_phase(uvm_phase phase);
   ...
   `uvm_info(get_type_name(),"env build_phase",UVM_HIGH)
 endfunction
 //------------------------- connect phase ----------------------
 function void environment::connect_phase(uvm_phase phase);
   ...
   `uvm_info(get_type_name(),"env connect_phase",UVM_HIGH)
 endfunction

...
analyze -verbose -format verilog "../rtl/uart_fifo.v"
analyze -verbose -format verilog "../rtl/tx.v"
analyze -verbose -format verilog "../rtl/rx.v"
analyze -verbose -format verilog "../rtl/uart_register_file.v"
analyze -verbose -format verilog "../rtl/uart_16550.v"
